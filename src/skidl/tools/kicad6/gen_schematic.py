...
"""
Generate a KiCad 6 schematic from a Circuit object.
...
def gen_schematic(
    ...
    **options
    ...
    for attempt in range(retries):
        ...
        node = SchNode(circuit, tool_modules[KICAD6], filepath, top_name, title, flatness)
        ...
        # KiCad 6 uses version 20240108.
        output_file = write_top_schematic(
            circuit, node, filepath, top_name, title, version=20240108
        )

...
class TestBBoxes:
    ...
    def test_calc_hier_label_bbox_returns_bbox(self):
        from skidl.tools.kicad8.bboxes import calc_hier_label_bbox
    ...
    def test_kicad6_bboxes_identical_to_kicad8(self):
        ...
        from skidl.tools.kicad8.bboxes import calc_hier_label_bbox as bbox8
...
class TestFinalizePartsAndNets:
    ...
    def test_removes_net_terminals(self):
        ...
        set_default_tool(KICAD8)
        from skidl.tools.kicad8.gen_schematic import preprocess_circuit, finalize_parts_and_nets
...
class TestImportConsistency:
    ...
    def test_kicad8_imports(self):
        from skidl.tools.kicad8.gen_schematic import gen_schematic
    ...
    def test_kicad9_is_kicad8(self):
        """kicad9 gen_schematic should be the exact same function as kicad8."""
        from skidl.tools.kicad8.gen_schematic import gen_schematic as gen8
        from skidl.tools.kicad9.gen_schematic import gen_schematic as gen9
        assert gen8 is gen9
    ...
    def test_bboxes_exports(self):
        ...
        from skidl.tools.kicad8.bboxes import calc_symbol_bbox, calc_hier_label_bbox
